namespace MajConsoSuiviSprint.Cli.Constants
{
    internal class AppliConstant
    {
        ...
        internal const string FileAppSettingsParDefaut = "appSettingsCheckConsoSprint.json";
        internal const string WebTTTSection = "WebTTT";
